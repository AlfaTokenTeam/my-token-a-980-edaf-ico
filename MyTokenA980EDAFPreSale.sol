...
import "./MyTokenA980EDAF.sol";

contract MyTokenA980EDAFPreSale {
    MyTokenA980EDAF public token;
    ...
    function MyTokenA980EDAFPreSale(
        MyTokenA980EDAF _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyTokenA980EDAF(_token);
